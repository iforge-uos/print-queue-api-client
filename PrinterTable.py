...
class PrinterTable(BaseTable):
    ...
    def increment(self, key, **kwargs):
        ...
        return self._request_action(method='put', action='increment', url_suffix=key, header=header, body=kwargs)
    ...
    def update(self, key, **kwargs):
        ...
        return self._request_action(method='put', action='update', url_suffix=key, header=header, body=kwargs)
