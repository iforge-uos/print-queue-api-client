...
class UserTable(BaseTable):
    ...
    def create(self, email, name, short_name=None, user_score=None, is_rep=None, score_editable=None):
    ...
    def update(self, key, **kwargs):
        ...
        return self._request_action(method='put', action='update', url_suffix=key, header=header, body=new_details)
